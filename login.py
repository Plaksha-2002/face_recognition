...
class Login:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\Plaksha\OneDrive\Desktop\DS\faceRecognition\college_image\background.jpg")
        ...
        lb1_bg.place(x=0,y=0,width=1530,height=810)


        title_lbl=Label(lb1_bg,text="FACE RECOGNITION ATTENDANCE SYSTEM",font=("times new roman",40,"bold"),bg="black", fg="white")
        ...
        img1=Image.open(r"C:\Users\Plaksha\OneDrive\Desktop\DS\faceRecognition\college_image\logo.jpg")
        img1=img1.resize((100,100),Image.ANTIALIAS)
        self.photoimage1=ImageTk.PhotoImage(img1)
        lb1img1 = Label(image=self.photoimage1,bg="#002B53")
        lb1img1.place(x=690,y=175, width=100,height=100)

        get_str = Label(frame1,text="Login",font=("times new roman",20,"bold"),fg="#112B3C",bg="white")
        get_str.place(x=140,y=100)

        #label1 
        username =lb1= Label(frame1,text="Username:",font=("times new roman",15,"bold"),fg="#112B3C",bg="white")
        ...
        #label2 
        pwd =lb1= Label(frame1,text="Password:",font=("times new roman",15,"bold"),fg="#112B3C",bg="white")
        ...
        loginbtn=Button(frame1,command=self.login,text="Login",font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="white",bg="black",activeforeground="white",activebackground="#002B53")
        loginbtn.place(x=33,y=320,width=270,height=35)


        # Creating Button Registration
        loginbtn=Button(frame1,command=self.reg,text="Register",font=("times new roman",10,"bold"),bd=0,relief=RIDGE,fg="#112B3C",bg="white",activeforeground="white",activebackground="#002B53")
        loginbtn.place(x=33,y=370,width=50,height=20)


        # Creating Button Forget
        loginbtn=Button(frame1,command=self.forget_pwd,text="Forget",font=("times new roman",10,"bold"),bd=0,relief=RIDGE,fg="#112B3C",bg="white",activeforeground="white",activebackground="#002B53")
    ...
    def forget_pwd(self):
        if self.txtuser.get()=="":
            ...
            if row==None:
                ...
                # -------------------fields-------------------
                #label1 
                ssq =lb1= Label(self.root2,text="Select Security Question:",font=("times new roman",15,"bold"),fg="#002B53",bg="#FAF0D7")
                ssq.place(x=70,y=80)
                ...
                #label2 
                sa =lb1= Label(self.root2,text="Security Answer:",font=("times new roman",15,"bold"),fg="#002B53",bg="#FAF0D7")
                sa.place(x=70,y=150)
...
# This part is image labels setting start 
        # first header image  
        img=Image.open(r"C:\Users\Plaksha\OneDrive\Desktop\DS\faceRecognition\college_image\student.png")
        ...
        # backgorund image 
        bg1=Image.open(r"C:\Users\Plaksha\OneDrive\Desktop\DS\faceRecognition\college_image\att.png")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # # student button 1
        std_img_btn=Image.open(r"C:\Users\Plaksha\OneDrive\Desktop\DS\faceRecognition\college_image\exit.png")
        ...
        det_img_btn=Image.open(r"C:\Users\Plaksha\OneDrive\Desktop\DS\faceRecognition\college_image\Top.png")
        ...
        att_img_btn=Image.open(r"C:\Users\Plaksha\OneDrive\Desktop\DS\faceRecognition\college_image\icon1.png")
        ...
        hlp_img_btn=Image.open(r"C:\Users\Plaksha\OneDrive\Desktop\DS\faceRecognition\college_image\train.png")
        ...
        # Start below buttons.........
        #  Train   button 5
        tra_img_btn=Image.open(r"C:\Users\Plaksha\OneDrive\Desktop\DS\faceRecognition\college_image\detector.png")
        ...
        # Photo   button 6
        pho_img_btn=Image.open(r"C:\Users\Plaksha\OneDrive\Desktop\DS\faceRecognition\college_image\help.jpg")
        ...
        # exit   button 8
        exi_img_btn=Image.open(r"C:\Users\Plaksha\OneDrive\Desktop\DS\faceRecognition\college_image\developer.jpg")
